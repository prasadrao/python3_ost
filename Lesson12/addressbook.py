...
if __name__ == "__main__":
    ...
    shelf.close()
    parser = OptionParser()
    parser.add_option('-a', '--action', dest="action", action="store", help="re\
quires -e option. Actions: add/delete")
 ...
 used in the -a option")
    ...
    elif '@' not in options.email:
        parser.error("option -e requires valid email address")
    try:
