...
class TestAddresses(unittest.TestCase):
    ...
    def setUp(self):
        self.home = Address( name='Steve Holden', street_address='1972 Flying Circus', city='Arlington', state='VAG', zip_code='12345-1234' )
    ...
    def test_state(self):
        self.assertEqual(self.home.state, 'VAG')
