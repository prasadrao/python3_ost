...
p1a = """While I was at the store in Washington, DC 20001 I tried to call (555) 123-4567
on my mobilebut accidentally called (555)-754-4321. The person on the line redirected
me to (999)-999-9999 which I don't think is a real number. Neither is (000)-000-0000 or
(555) 555-0000.
Well, I will try (555) 123-4567 again now."""
...
class TestRegex(unittest.TestCase):
    ...
    def test_search(self):
        ...
        #self.assertEqual(len(p1), result)
        self.assertEqual(len(p1), check_number(p1))
        self.assertEqual(len(p1a), check_number(p1a))
